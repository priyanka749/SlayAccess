...
import { default as HomeDelivery, default as Homedelivery } from "./pages/homedelivery.tsx";
        ...
        <>
            <QueryClientProvider client={queryClient}>
                <RouterProvider router={createBrowserRouter([
                    ...
                    {path:"/Contact",element:<Contact leftImageUrl={""} centerImageUrl={""} rightImageUrl={""}/>},
                 
                 
                    {path:"/AboutUs",element:<AboutUs leftImageUrl={""} centerImageUrl={""} rightImageUrl={""}/>},
