...
import { FaCartArrowDown, FaQuestionCircle, FaRegWindowClose } from "react-icons/fa";
        ...
        <>
            <div className={"nav-bar"}>
                ...
                <div className={"home-options"}>
                    <ul>
                        ...
                        <Link to={"/OurMenu"}><li className={activePage === "/OurMenu" ? "active" : ""}><a>Product</a></li></Link>
                        <Link to={"/AboutUs"}><li className={activePage === "/AboutUs" ? "active" : ""}><a>AboutUs</a></li></Link>
                        <Link to={"/contact"}><li className={activePage === "/AboutUs" ? "active" : ""}><a>Contact</a></li></Link>
            ...
            {login_popup && (
                <div className="login-modal">
                    ...
                    <div className="login-modal-content" style={{ width: '400px', height: '600px' }}>
                        <h2>Login</h2>
                        ...
                        <form onSubmit={handleSubmit(onSubmitLogin)}>
                            ...
                            <span className="" style={{ display: 'inline-block', width: '40px', height: '40px', textAlign: 'center' }}> </span>
                            ...
                            <div className="Remember-forget" style={{ fontSize: '2rem' }}>
                        <label style={{ display: 'inline-block', verticalAlign: 'middle', marginRight: '10px' }}>
                            <input type="checkbox" style={{ transform: 'scale(2)' }} />
                                  Remember me
                             </label>
                                   <a href="#" onClick={toggleforgetModal} style={{ fontSize: '1rem', verticalAlign: 'middle' }}>
                                Forget password?
                                 </a>
                                 </div>
                          <div className={'error-message top-error-message'}>
                            ...
                            <button type={"submit"} className={"btn-login10"} style={{  height: '40px', width: '150px', marginTop: '50px', marginRight: '100px' }}>Login</button>

                            <div className="register-text" style={{ marginTop: '50px' }}>
            ...
            <h2>Register</h2>
                ...
                <div className="form-group">
                    ...
                    <input
                        type="text"
                        id="fullName"
                        style={{ width: '100%', height: '60px',fontSize: '1.5rem' }} // Set the width and height inline
                ...
                <div className="form-group">
                    ...
                    />
                    {errors.securityQuestion && <p className="error-message">{errors.securityQuestion.message}</p>}
                </div>
