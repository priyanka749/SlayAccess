                ...
                <div className={"customer-page-right"}>
                    ...
                    <div className={"customer-page-main"}>
                        ...
                        <table className={"event-table2"}>
                            <thead>
                            <tr>
                                <th className={"name-box6"}>CustomerName</th>
                                <th className={"nid-box6"}>product ID</th>
                                <th className={"date-box6"}>Order date&time</th>
                                <th className={"price-box6"}>TotalPrice</th>
                                <th className={"delivery-box6"}>DeliveryOption</th>
                                <th className={"action-box6"}>Delete</th>
                            </tr>
                            </thead>
                            <tbody>
